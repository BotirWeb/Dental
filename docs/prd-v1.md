...
| 2 | Jadval | `/schedule` | owner, admin, doctor | ⬜ todo (hafta 3-4) |
| 3 | Bemorlar (qidirish) | `/patients` | owner, admin, doctor | ✅ tayyor (namuna slice — qidirish + yaratish) |
| 4 | Bemor kartasi | `/patients/:id` | owner, admin, doctor | 🟡 minimal (faqat asosiy ma'lumot; vizit/to'lov/qarz tarixi hafta 3-6 bilan birga) |
| 5 | Yozuv modal | (2-ekran ichida) | owner, admin | ⬜ todo (hafta 3-4) |
| 6 | Kassa / vizit yakuni | `/cashier` | owner, admin, cashier | ⬜ todo (hafta 5-6 — **ENG MUHIM ekran**) |
| 7 | Xarajatlar | `/expenses` | owner, admin | ⬜ todo (hafta 7-8) |
| 8 | Kunlik hisobot | `/reports/daily` | owner | ⬜ todo (hafta 9-11) |
| 9 | Oylik marja | `/reports/margin` | owner | ⬜ todo (hafta 9-11 — asosiy farqlanish nuqtasi, 1.1) |
| 10 | Shifokor hisobi | `/reports/doctors` | owner | ⬜ todo (hafta 9-11) |
| 11 | Xizmat va narxlar | `/services` | owner | ⬜ todo (hafta 7-8) |
| 12 | Foydalanuvchilar | `/users` | owner | ⬜ todo |

12 ekrandan 2 tasi to'liq/qisman ishlaydi (1, 3, va qisman 4) —
`docs/tasks/2026-09-22-tuzatishlar.md` shu holatni nazarda tutadi.
